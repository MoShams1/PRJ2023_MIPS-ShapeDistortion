...
jsonFilePath = '../../data/cyc03/MS01_task01_v2_20231024_164231.json';
...
% create data cell
typ_list = {'FG', 'BB_leftEdge', 'WB_rightEdge', 'FE_leftEdge', 'FE_rightEdge'};
dir_list = [-1, 1];
...
typ_list = {'FG', 'BB-LE', 'WB-RE', 'FE-LE', 'FE-RE'};
