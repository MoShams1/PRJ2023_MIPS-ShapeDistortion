...
[spearman_p, p] = corr(distortion_expected_FG,distortion_observed_FG, ...
    'type', 'spearman')
...
[spearman_p, p] = corr(distortion_observed_FE,distortion_expected_FE, ...
    'type', 'spearman')

%% plot scatter observed-inferred distortion

% figure('units','inches','outerposition',[7 1 4 4])
% hold on
% 
...
% figure('units','inches','outerposition',[11.5 1 4 4])
% 
